...
--
-- Host: localhost    Database: casas_cw
-- ------------------------------------------------------
...
CREATE TABLE `usuario` (
  ...
  KEY `casa` (`casa`),
  CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`casa`) REFERENCES `casas` (`ID_CASA`)
...
INSERT INTO `usuario` VALUES (1,'Usuario 1','12345',10,1);
...
-- Dump completed on 2023-06-12 16:28:23
